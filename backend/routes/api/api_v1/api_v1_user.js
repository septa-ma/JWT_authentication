...
router.post('/update', apiAuth, updateValidation, validateRequestSchema,UserController.updateUser.bind(UserController));
router.post('/user/image', apiAuth, uploadImage.single('image'), UserController.uploadImage.bind(UserController));
router.post('/location', apiAuth, addLocValidation, validateRequestSchema ,UserController.addLocation.bind(UserController)); 
